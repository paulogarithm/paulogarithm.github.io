...
\begin{center}
	...
	\\[9pt]
	{\Large Ingénieur Logiciel - Backend, Cloud \& Finance}
	\\
\end{center}
...
Ingénieur logiciel avec de solides bases en Go, Python et C/C++, orienté backend et cloud (Docker, Kubernetes, CI/CD), avec un intérêt marqué pour la {\bfseries finance}.
\\
...
\\
Formé à la comptabilité, à l'économie managériale et aux mathématiques à McGill University (Montréal), et pratique professionnelle de l'anglais (C1). En préparation de l'agrégation d'informatique.
\par\vspace{5pt}
