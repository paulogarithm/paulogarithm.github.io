...
\begin{center}
	...
	\\[9pt]
	{\Large Ingénieur Logiciel - Go, Cloud \& Systèmes}
	\\
\end{center}
...
Ingénieur logiciel avec de solides bases en Go, C/C++ et Python, orienté cloud, conteneurs et systèmes (Docker, Kubernetes, Linux, CI/CD).
\\
...
\\
\hspace*{5pt}{\bfseries Cloud \& Outils}: GCP, Docker, Kubernetes, Traefik, CI/CD, Git, Environnement Linux, gdb, Valgrind
\\
