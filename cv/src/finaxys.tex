...
\\
{\bfseries Contributeur open-source} : plus de 10 000 lignes de code sur des packages critiques. Préparation en cours de l'agrégation d'informatique {\bfseries (algorithmique des graphes, complexité, automates)}.
\par\vspace{5pt}
