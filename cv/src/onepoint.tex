...
Ingénieur logiciel avec de solides bases en Go, C/C++ et Python, orienté backend, cloud et automatisation (Docker, Kubernetes, CI/CD).
\\
...
\hspace*{5pt}{\bfseries Maîtrise}: Golang, Python, C/C++, Lua(u)
\\
\hspace*{5pt}{\bfseries Bonne connaissance}: SQL (PostgreSQL), Shell, Haskell, OCaml, Assembleur
\\
