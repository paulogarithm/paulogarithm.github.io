...
\begin{center}
	...
	\\[9pt]
	{\Large Ingénieur Logiciel - Développeur Backend \& DevOps}
	\\
\end{center}
...
Ingénieur logiciel avec de solides bases en Go, C/C++ et Python, orienté backend, cloud et automatisation.
\\
Expérience de développement dans des environnements exigeants : contributions open-source sous revue de code et CI/CD stricte (plus de 10 000 lignes de code sur Gno.land), démo présentée au CES 2024, enseignement auprès de plus de 400 étudiants.
\\
Formation complémentaire en management à McGill University (comptabilité, économie managériale, gestion de projet), utile pour dialoguer avec les métiers. En préparation de l'agrégation d'informatique.
\par\vspace{5pt}
...
\hspace*{5pt}{\bfseries Maîtrise}: Golang, Python, C/C++, Lua, SQL (PostgreSQL), Shell, Haskell, OCaml, Assembleur
\\
\hspace*{5pt}{\bfseries Notions}: Java, AWS (S3)
\\
