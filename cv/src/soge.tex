...
\begin{center}
	...
	\\[4pt]
	{\Large Ingénieur Logiciel - C++ \& Systèmes Performants}
	\\
\end{center}
...
Ingénieur logiciel orienté systèmes, spécialisé en C/C++ (optimisation de performance, programmation réseau, Linux), avec un intérêt marqué pour la {\bfseries finance de marché} et les systèmes de trading à faible latence.
\\
Formé à la comptabilité, à l'économie managériale et aux mathématiques à McGill University.
\\
