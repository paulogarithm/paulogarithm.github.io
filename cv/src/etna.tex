...
\begin{center}
	...
	\\[4pt]
	{\Large Ingénieur Logiciel - Accompagnement Pédagogique}
	\\
\end{center}
...
Assistant technique (ASTEK) à Epitech (groupe IONIS) pendant deux ans : {\bfseries plus de 400 étudiants} accompagnés en C, C++, assembleur et Haskell, création de contenus pédagogiques interactifs, goût marqué pour la transmission.
\\
Ingénieur logiciel aux compétences larges (développement, systèmes Linux, réseau, sécurité, DevOps), avec une formation complémentaire en management à McGill University, dont la sociologie du travail (Corporate Behaviour), et une pratique professionnelle de l'anglais (C1).
\\
En préparation de l'agrégation d'informatique {\bfseries (algorithmique des graphes, complexité, automates)}.
\par\vspace{5pt}
