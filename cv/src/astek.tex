...
Ingénieur logiciel spécialisé en C/C++ et programmation bas niveau (assembleur, gestion mémoire, réseau, Linux), attentif à la fiabilité du code : tests, Valgrind, CI/CD.
\\
...
\hspace*{5pt}{\bfseries Maîtrise}: C/C++, Golang, Python, Lua(u), Haskell, OCaml, Assembleur, Shell, SQL, Arduino (notions)
\\
