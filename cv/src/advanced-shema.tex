...
\begin{center}
	...
	\\[9pt]
	{\Large Ingénieur Logiciel - Backend, Cloud \& Data}
	\\
\end{center}
...
Ingénieur logiciel avec de solides bases en Go, Python et SQL, orienté backend, données et cloud (Docker, Kubernetes, CI/CD).
\\
...
\hspace*{5pt}{\bfseries Maîtrise}: Golang, Python, C/C++, Lua(u), SQL (PostgreSQL ; fenêtrage, jointures, optimisation de requêtes, algèbre relationnelle), Shell, Haskell, OCaml, Assembleur
\\
