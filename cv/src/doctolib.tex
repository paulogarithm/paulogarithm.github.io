...
\begin{center}
	...
	\\[9pt]
	{\Large Ingénieur Logiciel - Backend \& Systèmes Distribués}
	\\
\end{center}
...
Ingénieur logiciel avec de solides bases en Go, Python et C/C++, orienté backend et systèmes distribués. Intérêt marqué pour les architectures à grande échelle, la scalabilité et l'apprentissage de nouveaux langages (Java, Kotlin).
\\
Expérience de développement en Go sur un projet blockchain open-source (plus de 10 000 lignes de code, revue de code et CI/CD stricte) et sur un outil de migration multi-cloud (AWS, GCP).
\\
...
\hspace*{5pt}{\bfseries Maîtrise}: Golang, Python, C/C++, Lua
\\
\hspace*{5pt}{\bfseries Notions}: Java, Kotlin, AWS (S3)
\\
\hspace*{5pt}{\bfseries Systèmes \& Outils}: Docker, Kubernetes, CI/CD, Git, Environnement Linux, gdb, Valgrind
\\
