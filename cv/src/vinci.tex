...
\begin{center}
	...
	\\[9pt]
	{\Large Ingénieur Logiciel - Systèmes d'Information \& Données}
	\\
\end{center}
...
Ingénieur logiciel avec de solides bases en SQL, Go et Python, orienté systèmes d'information, données et automatisation. Rigueur, intégrité des données et qualité du code.
\\
Expérience dans des environnements exigeants : contributions open-source sous revue de code et CI/CD stricte (plus de 10 000 lignes de code), démo présentée au CES 2024.
\\
...
\hspace*{5pt}{\bfseries Maîtrise}: SQL (PostgreSQL ; fenêtrage, jointures, optimisation de requêtes), Golang, Python, C/C++, Shell, Haskell, OCaml
\\
\hspace*{5pt}{\bfseries Notions}: Java, COBOL (découverte), SAP ABAP (découverte), AWS (S3)
\\
\hspace*{5pt}{\bfseries Outils}: Git, Docker, Kubernetes, CI/CD, Environnement Linux, gdb, Valgrind
\\
