...
Ingénieur logiciel spécialisé en C/C++ et programmation bas niveau (assembleur, gestion mémoire, réseau, Linux), avec un intérêt pour les {\bfseries systèmes critiques et temps réel} (spatial, défense, aéronautique).
\\
Attentif à la fiabilité du code : tests, Valgrind, CI/CD, revue de code. Expérience en contexte industriel (Faurecia/Forvia, CES 2024).
\\
Un an d'études à Montréal (McGill University, management) et pratique professionnelle de l'anglais (C1). Préparation en cours de l'agrégation d'informatique.
\par\vspace{5pt}
...
\hspace*{5pt}{\bfseries Maîtrise}: C/C++, Golang, Python, Lua, Haskell, OCaml, Assembleur, Shell, SQL, Arduino (notions)
\\
