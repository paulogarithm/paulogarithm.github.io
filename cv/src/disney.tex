...
\par
\begin{adjustwidth}{5pt}{0pt}
    Implémentation from scratch des algorithmes {\bfseries AES et RSA} ({\ttfamily myAES}, {\ttfamily myRSA}), incluant un décodeur utilisant Lua pour l'analyse de flux.
\end{adjustwidth}
\par
{\bfseries Compétences :} C, cryptographie, AES, RSA, Lua
