...
\begin{center}
	...
	\\[9pt]
	{\Large Ingénieur Logiciel - Backend \& Systèmes}
	\\
\end{center}
...
Ingénieur logiciel avec de solides bases en Go, Python, SQL et C/C++, orienté backend et systèmes critiques. Attentif à la fiabilité du code : tests, Valgrind, CI/CD, intégrité des données.
\\
...
\hspace*{5pt}{\bfseries Maîtrise}: Golang, Python, SQL (PostgreSQL ; fenêtrage, jointures, optimisation de requêtes), C/C++, Shell, Haskell, OCaml
\\
